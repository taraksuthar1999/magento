...
class Ccc_Vendor_Block_Adminhtml_Vendor_Product_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('vendor_product_attribute_tabs');
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('vendor/adminhtml_vendor_product_attribute_edit_tab_main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('labels', array(
            ...
            'content'   => $this->getLayout()->createBlock('vendor/adminhtml_vendor_product_attribute_edit_tab_options')->toHtml(),
        ));
