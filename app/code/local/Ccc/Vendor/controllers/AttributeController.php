...
class Ccc_Vendor_AttributeController extends Mage_Core_Controller_Front_Action
{
    public function indexAction()
    {
        ...
        // // );
        // $this->getLayout()->getBlock('product_grid');
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            if (!$id) {
                ...
                $entityAttributeModel->setEntityTypeId($this->_entityTypeId);
            ...
            if (array_key_exists('select_group', $data)) {
            ...
            try {
                ...
                $entityAttributeModel->setAttributeId($model->getId())
                    ->save();
